...
export class CreateClientDto {
    ...
    @IsString({ message: 'La cédula de identidad o RIF debe ser una cadena de texto.' })
    @IsNotEmpty({ message: 'La cédula de identidad o RIF es obligatoria.' })
    @MinLength(8, { message: 'La cédula de identidad o RIF debe tener al menos 8 caracteres.' })
    @MaxLength(11, { message: 'La cédula de identidado RIF no debe exceder los 11 caracteres.' })
